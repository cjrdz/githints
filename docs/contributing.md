...
- Go 1.23 or later.
- Git.
- A Unix-like environment (Linux/macOS/WSL). Windows may work but is not the
  primary target.
...
- Update the relevant docs in `docs/` if your change affects architecture,
  usage, or contribution workflows.
